...
<body>
    ...
    <table style="table-layout: auto; margin: auto; margin-bottom: 25px;" width="667">
        <tbody>
            <tr>
                <td width="297">
                    <p>No Pemakaian : {{ $pemakaians->useCode }}</p>
                </td>
            </tr>
            <tr>
                <td width="297">
                    <p>Date : {{ $pemakaians->created_at }}</p>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody style="text-align: center">
            @foreach ($items as $item)
                <tr>
                    ...
                    <td width="65">
                        <p>{{ $item->pemakaian[0]->pivot->qtyUse }}</p>
                    </td>
                    <td width="72">
                        <p>{{ $item->satuan }}</p>
                    </td>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center">
                    <p>{{ trim($pemakaians->description, '<div></div>') }}</p>
                </td>
            </tr>
            <tr>
                <td style="text-align: center" colspan="2">
