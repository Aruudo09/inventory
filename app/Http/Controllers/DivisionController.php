...
class DivisionController extends Controller
{
    ...
    {
        return view('division.divisionIndex', [
    ...
    {
        return view('division.divisionCreate', [
            "title" => "profile"
        ]);
    }

    public function setText($id) {
        $output = Division::where('id', $id)->first();
    ...
    public function store(StoreDivisionRequest $request)
    {
        ...
        $request->session()->flash('success', 'Divisi baru berhasil dibuat!');
